        ...
        <div class="sidebar" id="xxx">
            ...
            <ul class="nav">
                ...
                <li class="nav-li current">
                    <a href="javascript:;" class="ue-clear"><i class="nav-ivon"></i><span class="nav-text">工作台</span></a>
                    <ul class="subnav">
                        <li class="subnav-li" href="{{url('index')}}" data-id="1"><a href="javascript:;" class="ue-clear"><i class="subnav-icon"></i><span class="subnav-text">首页</span></a></li>
                        ...
                        <li class="subnav-li" href="{{url('intelligentProbe')}}" data-id="3"><a href="javascript:;" class="ue-clear"><i class="subnav-icon"></i><span class="subnav-text">智能探针</span></a></li>
                        <li class="subnav-li" href="{{url('intelligentRadar')}}" data-id="4"><a href="javascript:;" class="ue-clear"><i class="subnav-icon"></i><span class="subnav-text">全景雷达</span></a></li>
                    </ul>
                </li>
            </ul>
