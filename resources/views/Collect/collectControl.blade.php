...
<div id="container" class="position">
    ...
    <div id="bd">
        <div id="main">
            <form action="{{url('collectControl')}}" method="post">
                ...
                <div class="search-box ue-clear">
                    ...
                    <div class="search-button" style="margin-left: 20px;">
                        ...
                        <input class="button" type="button" value="内派" onclick="insideAssign()"/>
                    </div>
                </div>
            </form>
            <div class="table">
                    ...
                    <table class="stable">
                        ...
                        @foreach($data as $v)
                            <tr class="str">
                                ...
                                <td class="std">@if(!empty($v->authUsers)){{$v->authUsers->name}}@endif</td>
                                <td class="std">{{$repayStatusList[$v->repay_status]}}</td>
                                <td class="std"><a href="javascript:;" onclick="exemption({{$v->id}})">豁免</a></td>
                            </tr>
                        @endforeach
                    </table>
                </div>
                ...
                <div id="htable" class="atable">
                    <div style="width: 90%;height: 30px;">豁免</div>
                    <div class="utable" id="utable13"></div>
                </div>
            </div>
        </div>
    </div>
