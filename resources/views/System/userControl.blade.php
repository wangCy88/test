                    ...
                    <table class="stable">
                        ...
                        @foreach($data as $k => $v)
                            <tr class="str">
                                ...
                                <td class="std">{{$v->authGroups->name}}</td>
                                <td class="std">{{$v->authMerchants->name}}</td>
                                <td class="std"><a href="javascript:;" onclick="modifyUser({{$v->id}})">修改用户</a>&nbsp;&nbsp;
                                    <a href="javascript:;" onclick="modifyUserPwd({{$v->id}})">修改密码</a>&nbsp;&nbsp;
                                    <a href="javascript:;" onclick="deleteUser({{$v->id}})">删除</a></td>
                            </tr>
                        @endforeach
                    </table>
                </div>
