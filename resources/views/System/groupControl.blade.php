        ...
        <div id="main">
            <div class="search-box ue-clear">
                <div class="search-button" style="margin-left: 20px;">
                    <input class="button" type="button" value="新增角色" onclick="addGroup()"/>
                </div>
            </div>
            <div class="table">
                <div class="grid">
                    <table class="stable">
                        ...
                        @foreach($data as $v)
                            <tr class="str">
                                ...
                                <td class="std"><a href="javascript:;" onclick="modifyGroup({{$v->id}})">修改</a>&nbsp;&nbsp;<a href="javascript:;" onclick="deleteGroup({{$v->id}})">删除</a></td>
                            </tr>
                        @endforeach
                    </table>
                </div>
            ...
            <div id="gtable1" class="atable">
                ...
                <div class="utable">
                    ...
                    <ul id="utable9"></ul>
                    <div class='div center'> <button type='button' class='span' onclick='addGroupDo()'>新增</button><button type='button' class='span' onclick='closeDetails()'>关闭</button></div>
                </div>
            </div>
            <div id="gtable2" class="atable">
                ...
                <div class="utable">
                    ...
                    <ul id="utable10"></ul>
                    <div class='div center'> <button type='button' class='span' onclick='modifyGroupDo()'>修改</button><button type='button' class='span' onclick='closeDetails()'>关闭</button></div>
                </div>
            </div>
        </div>
    </div>
