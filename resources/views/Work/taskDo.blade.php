...
<div id="container" class="position">
    ...
    <div id="bd">
        <div id="main">
            <form action="{{url('taskDo')}}" method="post">
                    ...
                    <table class="stable">
                        ...
                        @foreach($data as $v)
                            <tr class="str">
                                ...
                                <td class="std"><a href="javascript:;" onclick="viewProcess({{$v->id}},{{$v->userid}})">查看流程</a>@if($v->status === 1)&nbsp;&nbsp;<a href="javascript:;" onclick="scoreDo({{$v->id}})">打分</a>@endif</td>
                            </tr>
                        @endforeach
                    </table>
                </div>
                <div class="grid">
                    {{ $data->appends(['id' => $id, 'process' => $process, 'loan' => $loan,
            ...
            <div id="atable" class="atable">
                <div style="width: 90%;height: 30px;">打分</div>
                <div class="utable" id="utable3">
                    <input type="hidden" id="orderid"/>
                    <table class="stable">
                        <tr class="str">
                            <th class="sth">通过审核分值区间:</th>
                            <td class="std">85~90</td>
                        </tr>
                        <tr class="str">
                            <th class="sth">人工审核分值区间:</th>
                            <td class="std">10~84</td>
                        </tr>
                        <tr class="str">
                            <th class="sth">拒绝审核分值区间:</th>
                            <td class="std">0~9</td>
                        </tr>
                        <tr class="str">
                            <td class="std" colspan="2">打分:&nbsp;&nbsp;<input type="text" id="score"/>&nbsp;&nbsp;
                                <select id="status">
                                ...
                                <input type="button" value="确定" onclick="score()"/></td>
                        </tr>
                    </table>
                </div>
            </div>
