...
<div id="container" class="position">
    ...
    <div id="bd">
        <div id="main">
            <form action="{{url('repaymentControl')}}" method="post">
                        ...
                        <div class="kv-item ue-clear">
                            ...
                            <div class="kv-item-content">
                                <select style="width: 120px;" name="repay_status">
                                    <option value="">全部</option>
                                    <option value="0" @if($repay_status === '0') selected="selected" @endif>未还款</option>
                                    <option value="1" @if($repay_status === '1') selected="selected" @endif>已还款</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="search-box ue-clear">
                    <div class="search-area">
                        <div class="kv-item ue-clear">
                            <label>应还款日:</label>
                            <div class="kv-item-content">
                                <input type="date" style="width: 120px;height: 25px;" name="repayment_at1" value="{{$repayment_at1}}"/>
                                <span>~</span>
                                <input type="date" style="width: 120px;height: 25px;" name="repayment_at2" value="{{$repayment_at2}}"/>
                            </div>
                        </div>
                    </div>
                    <div class="search-area">
            ...
            <div class="table">
                ...
                <div class="grid">
                    ...
                    'repay_status' => $repay_status, 'date1' => $date1, 'date2' => $date2, 'withdraw_amount1' => $withdraw_amount1,
                    ...
                    'net_receipts2' => $net_receipts2, 'loan_at1' => $loan_at1, 'loan_at2' => $loan_at2, 'repayment_at1' => $repayment_at1,
                    'repayment_at2' => $repayment_at2, 'extension1' => $extension1, 'extension2' => $extension2, 'extension_amount1' => $extension_amount1,
            ...
            <div class="table" style="width: 50%;">
                <div class="grid">
                    <table class="stable">
                        <tr class="str">
                            <th class="sth">累计用户申请金额</th>
                            <th class="sth">累计实际到账金额</th>
                            <th class="sth">累计实际本金</th>
                            <th class="sth">累计放款豁免金额</th>
                            <th class="sth">累计滞纳金</th>
                            <th class="sth">累计展期费用</th>
                            <th class="sth">累计还款总额</th>
                        </tr>
                        <tr class="str">
                            <td class="std">{{$total_withdraw_amount}}</td>
                            <td class="std">{{$total_net_receipts}}</td>
                            <td class="std">{{$total_withdraw_amount}}</td>
                            <td class="std">{{$total_exemption_amount}}</td>
                            <td class="std">{{$total_late_fee}}</td>
                            <td class="std">{{$total_extension_amount}}</td>
                            <td class="std">{{$total_total_fee}}</td>
                        </tr>
                    </table>
                </div>
            </div>
