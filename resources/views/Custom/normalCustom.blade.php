...
<div id="container" class="position">
    ...
    <div id="bd">
        <div id="main">
            <form action="{{url('normalCustom')}}" method="post">
                ...
                <div class="search-box ue-clear">
                    ...
                    @if($autoRaiseAndReduceSwitch == 1)
                        <div class="search-button" style="margin-left: 20px;">
                            <input class="button" type="button" value="关闭自动提额" onclick="changeAutoRaise(0)"/>
                        </div>
                    @else
                        <div class="search-button" style="margin-left: 20px;">
                            <input class="button" type="button" value="开启自动提额" onclick="changeAutoRaise(1)"/>
                        </div>
                    @endif
                </div>
            </form>
                    ...
                    <table class="stable">
                        ...
                        @foreach($data as $v)
                            <tr class="str">
                                ...
                                <td class="std">@if(!empty($v->merchantUsers))<a href="javascript:;" onclick="getDetails({{$v->merchantUsers->id}})">查看</a>&nbsp;&nbsp;<a href="javascript:;" onclick="adjustLimit({{$v->id}})">调整额度</a>@endif</td>
                            </tr>
                        @endforeach
                    </table>
                </div>
